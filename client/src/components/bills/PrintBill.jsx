...
export default function PrintBill({
  ...
  //print bill
  const componentRef=useRef(); //ref içinde yollanır
  ...
  return (
    <div>
      ...
      >
          ...
          <div className="max-w-5xl mx-auto bg-white px-6">
            <article className="overflow-hidden">
              <div className="logo my-6">
                <h2 className="text-4xl font-bold logo-bill-container">LOGO</h2>
              </div>
              <div className="bill-details">
                <div className="grid sm:grid-cols-4 grid-cols-3 gap-12">
                  <div className="text-md text-slate-500">
                    ...
                    <p> {selectedCustomer?.customerPhoneNumber}</p>
                    <p> San Javier </p>
                    <p> CA 1234</p>
                  </div>
                  <div className="text-md text-slate-500">
                  ...
                  <div className="text-md text-slate-500">
                    <div>
                      ...
                      <p>{Math.floor(Math.random(0, 100) * 100)}</p>
                    </div>
                    <div>
                      <p className="font-bold text-slate-700 mt-2">
                        Veriliş Tarihi:
                      </p>
                      <p>{selectedCustomer?.createdAt.substring(0, 10)}</p>
                    </div>
                  </div>
              ...
              <div className="bill-table-area mt-8">
                <table className="min-w-full divide-y divide-slate-500 overflow-hidden">
                  ...
                  <tbody>
                    {/* sadece tıklanan müşterinin ürün bilgisini yansıtır :selectedCustomer */}
                    ...
                    <tr>
                      ...
                      <th className="text-right pt-4" scope="row">
                        <span className="font-normal text-red-600">
                          +{(selectedCustomer?.tax).toFixed(2)}₺
                        </span>
                      </th>
                    </tr>
                    <tr>
        ...
        <div className="flex justify-end p-2 border-t border-[#e0e3fe] py-3">
          <Button

            htmlType="submit"
            onClick={handlePrintBill}
            className="w-1/7 text-white bg-gradient-to-r from-[#6988ef] via-[#76a1ff] to-[#3c5fd0] font-[800] text-sm rounded-lg hover:text-white hover:bg-gradient-to-br hover:from-[#b9b4e7] hover:to-[#c7d5f3]"
          >
            YAZDIR
          </Button>
        </div>
